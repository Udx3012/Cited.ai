          ...
          if (match) {
            ...
            return (
              <button
                ...
                className={`inline-flex items-center justify-center w-5 h-5 mx-1 text-[10px] font-bold rounded ${isHighlighted ? "bg-[#45A29E] text-black" : "bg-zinc-800 text-[#45A29E] hover:bg-zinc-700"
                  } transition-all`}
              >
                {citId}
              </button>
